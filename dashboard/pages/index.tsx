        ...
        <Container>
            ...
            <Container css={ {
                ...
                <Link css={ {fontSize: '$xl', fontWeight: '$semibold'} } href='/'>
                    { data ? data.name : "Kurumi Music Bot" }
                </Link>
            ...
            <Container style={ {
                ...
                <Text h1 css={ {textGradient: "180deg, $blue600 -20%, $blue800 100%",} }>Kurumi Music Bot</Text>
                <Text h3 css={ {color: '$gray800'} }>An advanced Kurumi Music Bot, supports Spotify, SoundCloud,
                ...
                <Container css={ {display: 'flex', alignItems: 'center', justifyContent: 'center'} }>
                    ...
                    <Button color="primary" flat
                            onClick={ () => window.open('https://github.com/kadantte/Kurumi-music') } style={ {
                        marginTop: '1rem',
                        marginLeft: '20px'
                    } }>Github
                    </Button>
