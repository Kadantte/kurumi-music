...
const command = new SlashCommand()
  ...
  .setRun(async (client, interaction) => {
    ...
    helpEmbed.addFields({
      name: "Credits",
      value:
        `Kurumi Music Bot Version: v${
          require("../../package.json").version
        }; Build: ${gitHash}` +
        "\n" +
        `[✨ Support Server](${client.config.supportServer}) | [Issues](${client.config.Issues}) | [Source](https://github.com/kadantte/Kurumi-music/tree/v5) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`,
    });
